...
<body>
    <section class="login-section">
        ...
        <p class="text-create-account">Back To <a href="<?php echo e(route('register')); ?>" class="text-sign-up">Register Page</a></p>
    </section>
</body>
</html><?php /**PATH /Users/Salma/Documents/kuylinary/resources/views/register/registadmin.blade.php ENDPATH**/ ?>